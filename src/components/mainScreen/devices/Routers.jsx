...
export default function ro(props) {
    ...
    const divIconClass = "p-1 my-2 flex items-center hover:shadow-2xl hover:shadow-gray-600  justify-center transition-[0.2s] box-content h-[70px] w-[70px] hover:outline-dashed hover:outline-primary hover:outline-[2px] rounded-[28px] mx-2  hover:bg-background bg-secondary transition cursor-pointer";
